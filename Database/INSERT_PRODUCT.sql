--BUTCHERS
--CHICKEN
INSERT INTO PRODUCT(PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('1', 'CHICKEN', 'WHITE MEAT', 'Chicken is the most common type of poultry. Chicken meat and eggs have become common in many cuisines due to the relative ease and low cost of keeping chickens compared to mammals such as cattle or hogs', '2.46', '15' , 'chicken.png','1');
...
--PORK
INSERT INTO PRODUCT(PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES('4','PORK','RED MEAT', 'Pork is classified as red meat due to myoglobin levels in the meat. Even though fresh pork is lighter in color than beef and cooks to become very light.','2.64','17','pork.jpg','1');
...
--FRUITS
--ORANGE
INSERT INTO PRODUCT(PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES('14','ORANGE','FRUIT','An orange has a tough shiny orange skin. Inside, the fruit is divided into "segments", which have thin tough skins that hold together many little sections with juice inside. in some oranges it is hard to take the skin off. ','2','20', 'orange.jpg','4');
...
--TUNA
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('22', 'TUNA', 'FISH', 'Tuna is a saltwater fish eaten all over the world. it is incredibly nutritious and a great source of protein, omega-3 fatty acids.', '3.5', '5' , 'tuna.jpg','3');
...
--LOBSTER
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('26', 'LOBSTER', 'SHELLFISH', 'The king of the crustaceans, lobster is a delicacy that commands a very high price, with white, firm meat that is sweet and succulent. Before it is cooked, lobster shell has a very dark color.', '3.46', '15' , 'lobster.jpg','3');
...
--PRAWN
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE,SHOP_ID, Rating) VALUES ('28', 'PRAWN', 'SHELLFISH', 'Prawn are important types of seafood that are consumed worldwide. They are a rich source of selenium, one of the most effective antioxidants at maintaining healthy cells. ','6', '15' , 'prawn.jpg','3');
...
--BAGEL
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('31', 'BAGEL','BAKED ITEMS', 'A bagel (also spelled beigel) is a type of bread, traditionally shaped by hand into the form of a ring from wheat dough, roughly hand-sized. It is made from whole grains.', '1','25', 'bagel.jpg','2');
...
--CAKE
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('33', 'CAKE', 'BAKED ITEMS','Cake is a form of sweet food made from flour, sugar, and other ingredients, that is usually baked. In their oldest forms, cakes were modifications of bread, but cakes now cover a wide range of preparations.', '10','20', 'cake.jpg','2');
...
--CROISSANT
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_TITLE, CATEGORY, DESCRIPTION, PRICE, STOCK_QUANTITY, IMAGE, SHOP_ID, Rating) VALUES ('36', 'CROISSANT','BAKED ITEMS', 'A croissant is a buttery, crescent-shaped French pastry. good croissants are light, flaky, and delicately sweet. Compared to other sweets, croissant is distinguished by the content of protein.', '3','20', 'croissant.jpg','2');
