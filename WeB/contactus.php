...
<body>
  ...
  <div class="row text-center">
      <div class="col-lg-4 py-2 m-2 mx-auto td-con" style="width: 21rem;">
        <div class="card-body">
          <h5 class="card-title">Please fill the form below!</h5>
          <div class="name-f">
        <label for="name">Name: </label>
        <input type="text" placeholder="Your Name Here" size="20" class="text-center">
        </div>
        <div class="email-f mt-2 pb-2">
        <label for="email">Email: </label>
        <input type="email" placeholder="Your Email Here" size="20" class="text-center">
        </div>
