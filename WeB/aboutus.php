...
<body>
    ...
    <br>
    <br>
    <div id="OH" class="container" style="border: 5px solid grey; margin-top: 5%; height: auto; background-color: white;">
    ...
    <div id="MOT" class="container">
      <h1 class="text-center pb-4 text-u" style="margin-top: 3%;">Meet Our Team</h1>
